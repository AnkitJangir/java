...
public class np  implements ActionListener,KeyListener,MouseListener
{
	static Frame f,f1;   MenuBar mb;   Menu m1,m2;    Panel p; TextArea ta;   TextField t1,t2;  Button b1,b2,b3,b4;  Label l,l1,l2;
     int flag=0,flag1=0,flag2=0; int n=0,n1=0,n2=0,x,y,entry=0;   FileDialog fd;
         ...
         { 
              ...
              if(f.getTitle().equals("Untitled-Notepad*"))
                 {
                   ...
                   fis.close();
                   f.setTitle(names); flag=0; flag2=0;
			...
			System.out.print("in else");  
		       //String path=fd.getDirectory();
				...
				if(flag1==1)
				   { f.setTitle("Untitled-Notepad"); ta.setText("");flag1=0; flag=0;}
