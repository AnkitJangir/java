...
public class np  implements ActionListener,KeyListener,MouseListener
{
	static Frame f,f1;   MenuBar mb;   Menu m1,m2;    Panel p; TextArea ta;   TextField t1,t2;  Button b1,b2,b3,b4;  Label l,l1,l2;
     int flag=0,flag1=0,flag2=0,flag3=0,flag4=0,flag5=0,flag6=0,flag7=0,flag8=0,flag9=0; int n=0,n1=0,n2=0,x,y,entry=0;   FileDialog fd;
            ...
            else
	    {
         ...
         { 
            try
            {
              ...
              s2=f.getTitle();
              s1=f.getTitle();
              if(s2.endsWith("*")&&f.getTitle().equals("Untitled-Notepad*"))
              {
              	flag8=0;
              }
              else if(s2.endsWith("*"))
              ...
              if(flag8==1)
              {
              	 ...
              	 System.out.println("name"+name+"paths "+path);
              		//File f8=new File(path,name);
              		//paths=f8.getName();//.getDirectory();
              		//System.out.println("paths::"+f8.getName());
                   //names=f8.getPath();//s1.getFile();
                   //System.out.println("name"+names+"paths "+paths);
              ...
              if(f.getTitle().equals("Untitled-Notepad*")||(s2.endsWith("*")))
                 {
                   ...
                   f.setTitle(names); 
                   	...
                   	/*if(com.equals("New"))
                   	{
                   		System.out.println("ANkit Jangir AJJJ");
                   		flag1=1;}*/
                   		System.out.println("ANKKKKK");
            ...
            if(flag5==1)
            {
             if(flag4==1)
             {
             	flag5=0;
             	flag4=0;
             	System.out.println("Flag5 at the OPen"+flag5);
				if(flag3==1)
				{
					try	
					{
