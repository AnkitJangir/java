...
/////////////////////////////////////// window frame cross"X" button workinggggggg ///////////     
   public void windowClosing(WindowEvent e)
   {
        ...
        if(e.getSource()==f1)  // find window closing
        {
        	f1.setVisible(false);
       	    f1.dispose();
        }
        if(e.getSource()==f2)  // findreplace window closing
        {
	        f2.setVisible(false);
            f2.dispose();
        }
        if(e.getSource()==f3)  // Do u want save window closing
        {
     	   f3.setVisible(false);
           f3.dispose();
        }
