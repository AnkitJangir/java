...
class ff
{
	public static void main (String args [])
	{
		...
		Checkbox cbA = new Checkbox ("   A:     Samarth Thol" , true );
		Checkbox cbB = new Checkbox ("   B:     S a m a r t h   T h o l i a" , false );
		Checkbox cbC = new Checkbox ("   C:     SAMARTH THOLIA" , false );
		Checkbox cbD = new Checkbox ("   D:     S A M R T H   T H O L I A" , false );
		p3.add (cbA);
		p3.add (cbB);
		p3.add (cbC);
		p3.add (cbD);
